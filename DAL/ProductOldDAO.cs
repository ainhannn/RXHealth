...
//        private static ProductOld ConvertToDTO_FullBatch(List<object> row) //full properties
//        {
//            try
//            {
//                int productId = Convert.ToInt16(row[0]);
//                ProductOld obj = new Product()
//                {
...
//            } catch { return null; }
//        }
//        private static ProductOld ConvertToDTO_AvailableBatch(List<object> row)
//        {
//            try
//            {
//                int productId = Convert.ToInt16(row[0]);
...
//        public static List<ProductOld> SelectAll()
//        {
//            string sql = string.Format("SELECT * FROM {0}", dbViewName);
//            var table = ExecuteReader(sql);
//            var list = new List<ProductOld>();
...
//            return list;
//        }
//        public static List<ProductOld> SelectAll_Sale()
//        {
...
//        public static ProductOld Select(int productId)
//        {
...
//        public static List<ProductOld> AdvancedSearch(Dictionary<string, string> conditions)
//        {
//            var list = new List<ProductOld>();
...
//            return list;
//        }
//        public static bool Insert(ProductOld e)
//        {
...
//        public static bool Update(ProductOld e)
//        {
//            string sql = string.Format(
//                "UPDATE SET stack = '{2}', rate = {3}, is_on_sale = {4} " +
